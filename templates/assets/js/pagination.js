...
(function(global, $) {
  ...
  $.fn[pluginName].defaults = {
    ...
    // 'Previous' text
    // prevText: '&lsaquo;',<i class="fas fa-angle-left"></i>
    prevText: '<span><i class="fas fa-angle-left"></i> Prev</span>',
    // 'Next' text
    nextText: '<span>Next <i class="fas fa-angle-right"></i></span>',

    // Ellipsis text
    ellipsisText: '<span style="font-size: 22px; font-weight: 600;">...</span>',
